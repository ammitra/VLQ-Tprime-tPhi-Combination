#!/bin/bash
maskCRargs="mask_Name1_SR_fail_LOW=0,mask_Name1_SR_fail_SIG=0,mask_Name1_SR_fail_HIGH=0,mask_Name1_SR_pass_LOW=0,mask_Name1_SR_pass_SIG=0,mask_Name1_SR_pass_HIGH=0,mask_Name1_ttbarCR_fail_LOW=1,mask_Name1_ttbarCR_fail_SIG=1,mask_Name1_ttbarCR_fail_HIGH=1,mask_Name1_ttbarCR_pass_LOW=1,mask_Name1_ttbarCR_pass_SIG=1,mask_Name1_ttbarCR_pass_HIGH=1,mask_Name2_S1_muon=1,mask_Name2_S1_electron=1,mask_Name2_S2_muon=1,mask_Name2_S2_electron=1,mask_Name2_S3_muon=1,mask_Name2_S3_electron=1,mask_Name2_S4_muon=1,mask_Name2_S4_electron=1,mask_Name2_V1_muon=1,mask_Name2_V1_electron=1,mask_Name2_V2_muon=1,mask_Name2_V2_electron=1,mask_Name2_V3_muon=1,mask_Name2_V3_electron=1,mask_Name2_V4_muon=1,mask_Name2_V4_electron=1"
...
(set -x; combine -M AsymptoticLimits -d workspace_masked.root --saveWorkspace -v 2 -n "_B2G-22-001" -s $seed --setParameters "${maskCRargs},${setCRparams}" --freezeParameters "${freezeCRparams}" --cminDefaultMinimizerTolerance $tol --cminDefaultMinimizerStrategy $strat --X-rtd MINIMIZER_MaxCalls=400000 --rMin -1 --rMax $rmax)
