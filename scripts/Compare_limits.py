'''
Compare the limits b/w the combination and B2G-22-001/B2G-23-009 independently
'''
...
MPs = np.array([i for i in MPs if i != 225r])
...
fig.savefig('plots/limits_2D_box.pdf',bbox_inches='tight')